...
def create_server_plots(server_data, leaf_servers, plots_dir):
    ...
    for server_id in leaf_servers:
        ...
        fig.suptitle(f'HierFL Server {server_id} - CIFAR-10 overview', fontsize=16, fontweight='bold')
...
def create_global_plot(global_metrics, plots_dir):
    ...
    # Create figure with 2x2 subplots
    fig, axes = plt.subplots(2, 2, figsize=(15, 10))
    fig.suptitle('HierFL - CIFAR-10 Cloud Metrics overview', fontsize=16, fontweight='bold')
